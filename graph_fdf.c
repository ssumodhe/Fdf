...
/*   Updated: 2017/03/20 18:57:40 by ssumodhe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
(void)data;
	...
	ft_drawline_img(map, window->win_w - (window->gap*2), window->win_h - (window->gap*2),0,window->win_h - (window->gap*2), 0x00FFFFFF);
